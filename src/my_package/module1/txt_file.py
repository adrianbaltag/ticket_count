...
# from my_package.module1.extract_docx_info import (
#     extract_investigation_info,
#     find_nrb_docx,
# )
# from my_package.module1.nrb_ticket import get_nrb_ticket
# from my_package.module1.read_docx import read_docx
...
#                         old_ticket_status = line.strip().split(":")[1].strip().lower()
#                         break
...
#             print(
#                 Fore.CYAN + f"✅ Renamed file: {existing_file_path} → {new_file_path}"
#             )
...
#                     actual_status = line.strip().split(":")[1].strip().lower()
